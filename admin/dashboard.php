...
<body>
        ...
        <div class="d-flex flex-column">
            ...
            <nav class="nav-menu">
                <ul>
                    ...
                    <li><a href="#trabajos"><i class="bx bx-book-content"></i>Trabajos</a></li>
    ...
    <main id="main">
        ...
        <section id="trabajos" class="trabajos">
            <div class="container">
                <form id="form_data_work" method="post">
                    <div class="section-title">
                        <h2>TRABAJOS</h2>
                    </div>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_trabajo" onclick="fntDibujoTrabajo()">
                        REGISTROS INSERTADOS
                    </button>
                    <div class="row">
                        <div class="input-group input-group-sm col-6 ">
                            <div class="input-group-prepend">
                                <span class="input-group-text  alert-primary" id="inputGroup-sizing-sm">PARAMETRO DE TRABAJO</span>
                            </div>
                            <input type="hidden" id="idMenuWork" name="idMenuWork" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                            <input type="text" id="parametro" name="parametro" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        </div>
                    </div>
                    <button type="button" class="btn btn-success" onclick="fntInsertWork()">
                        GUARDAR REGISTRO NUEVO
                    </button>
                    ...
                    <div class="modal fade" id="modal_trabajo" tabindex="-1" role="dialog" aria-labelledby="modal_trabajoLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h2 class="modal-title" id="modal_trabajoLabel">TABLA TRABAJOS</h2>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="dibujo_tabla_trabajo_" id="dibujo_tabla_trabajo_" name="dibujo_tabla_trabajo_"></div>
                                </div>

                            </div>
                        </div>
                    </div>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_cv" onclick="fntDibujoTrabajoCv()">
                        REGISTROS INSERTADOS
                    </button>
                    <div class="col-12"></div>
                </form>

                <form id="form_data_work_cv" method="post">
                    <div class="row">
                        <div class="input-group input-group-sm col-6 ">
                            <div class="input-group-prepend">
                                <span class="input-group-text  alert-primary" id="inputGroup-sizing-sm">PARAMETRO DE CV</span>
                            </div>
                            <input type="hidden" id="idMenuCv" name="idMenuCv" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                            <input type="text" id="parametro" name="parametro" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        </div>
                    </div>
                    <button type="button" class="btn btn-success" onclick="fntInsertWorkCv()">
                        GUARDAR REGISTRO NUEVO
                    </button>


                    <div class="modal fade" id="modal_cv" tabindex="-1" role="dialog" aria-labelledby="modal_cvLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h2 class="modal-title" id="modal_cvLabel">TABLA CV</h2>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="dibujo_tabla_trabajo_cv_" id="dibujo_tabla_trabajo_cv_" name="dibujo_tabla_trabajo_cv_"></div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                </div>
