        ...
        <ul class="nav nav-pills nav-fill btn-dark">
          <li class="nav-item">
            ...
            <div class="cliente" id="cliente">
              <input name="clipboard" id="clipboard" type="text" value="<?php echo $nombre ?>">
              <input name="idAgente" id="idAgente" type="text" value="<?php echo $nombre ?>">
            </div>
          </li>
          <li class="nav-item">
            <?php if ($gt == 1) { ?>
          ...
          <li class="nav-item">
            <button type="button" id="replace" name="replace" onclick="fntClear()" class="btn btn-dark btn-block">Cancelar</button>
          </li>
          <li class="nav-item">
            <button type="button" id="replace" name="replace" class="btn btn-info btn-block">Gestiones - <?php echo $contadorGestiones ?> </button>
          </li>
        </ul>
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="one" role="tabpanel" aria-labelledby="one-tab"></br>
            ...
            <div class="form-group row ">
              ...
              <div class="col-7">
                <div class="form-group row ">
                  <a for="tarjeta" class="col-sm-1 col-form-label" disabled>Tarjeta</a>
                  <div class="col-sm-2">
                    <input class="form-control form-control-sm " name="tarjeta" id="tarjeta" type="text" value="<?php echo $codiclie ?>" disabled>
                  </div>
                  <a for="cif" class="col-sm-1 col-form-label">Cif</a>
                  <div class="col-sm-2">
                    <input class="form-control form-control-sm " name="cif" id="last_name" type="cif" type="text" value="<?php echo $codiempr ?>" disabled>
                  </div>
                  <a for="tipo_producto" class="col-sm-2 col-form-label">Tipo De Producto</a>
                  <div class="col-sm-2">
                    <input class="form-control form-control-sm " name="tipo_producto" id="tipo_producto" type="text" value="<?php echo $claprod ?>" disabled>
                  </div>
                  <div class="col-2"></div>
                  <a for="ciclo_ven_q" class="col-sm-2 col-form-label">Ciclo Vencido Q</a>
                  <div class="col-sm-1">
                    <input style="text-align:right;" class="form-control form-control-sm " name="ciclo_ven_q" id="ciclo_ven_q" type="text" value="<?php echo $cicloveq ?>" disabled>
                  </div>
                  <a for="ciclo_ven_s" class="col-sm-2 col-form-label">Ciclo Vencido $</a>
                  <div class="col-sm-1">
                    <input style="text-align:right;" class="form-control form-control-sm " name="ciclo_ven_s" id="ciclo_ven_s" type="text" value="<?php echo $cicloved ?>" disabled>
                  </div>
                  <a for="Extrafinanciamiento" class="col-sm-2 col-form-label">Extrafinanciamiento</a>
                  <div class="col-sm-2">
                    <input style="text-align:right;" class="form-control form-control-sm " name="Extrafinanciamiento" id="Extrafinanciamiento" type="text" value="<?php echo $extrafin ?>" disabled>
                  </div>
                </div>
              </div>
              <div class=" col-4">
                <div class="form-group row ">
                  <a for="ult_pago_q" class="col-sm-2 col-form-label">Ult.Pago Q</a>
                  <div class="col-sm-4">
                    <input class="form-control form-control-sm " name="ult_pago_q" id="ult_pago_q" type="date" value="<?php echo $fultpago ?>" disabled>
                  </div>
                  <a for="ult_pago_s" class="col-sm-2 col-form-label">Ult.Pago $</a>
                  <div class="col-sm-4">
                    <input class="form-control form-control-sm " name="ult_pago_s" id="ult_pago_s" type="date" value="<?php echo $fultpagd ?>" disabled>
                  </div>
                  <a for="dia_pago" class="col-sm-3 col-form-label">Dia De Pago</a>
                  <div class="col-sm-3">
                    <input style="text-align:right;" class="form-control form-control-sm " name="dia_pago" id="dia_pago" type="text" value="<?php echo $diapago ?>" disabled>
                  </div>
                  <a for="Llamadas" class="col-sm-3 col-form-label">Llamadas</a>
                  <div class="col-sm-3">
            ...
            <div class="form-group col-12 row ">
              <div class="form-group col-12 row ">
                <div class="col-1"></div>
                <a for="saldo_ven_q" class="col-sm-1 col-form-label">Saldo Vencido Q</a>
                <div class="col-sm-1">
                  <input style="text-align:right;" class="form-control form-control-sm " name="saldo_ven_q" id="saldo_ven_q" type="text" value="<?php echo $saldoveq ?>" disabled>
                </div>
                <a for="pago_min_q" class="col-sm-1 col-form-label">Pago Minimo Q</a>
                <div class="col-sm-1">
                  <input style="text-align:right;" class="form-control form-control-sm " name="pago_min_q" id="pago_min_q" type="text" value="<?php echo $pagominq ?>" disabled>
                </div>
                <a for="saldo_ini_q" class="col-sm-1 col-form-label">Saldo Inicial Q</a>
                <div class="col-sm-1">
                  <input style="text-align:right;" class="form-control form-control-sm " name="saldo_ini_q" id="saldo_ini_q" type="text" value="<?php echo $saldo ?>" disabled>
                </div>
                <a for="abono_q" class="col-sm-1 col-form-label">Abono Q</a>
                <div class="col-sm-1">
                  <input style="text-align:right;" class="form-control form-control-sm " name="abono_q" id="abono_q" type="text" value="<?php echo $pagos ?>" disabled>
                </div>
                <a for="saldo_act_q" class="col-sm-1 col-form-label">Saldo Actual Q</a>
                <div class="col-sm-1">
                  <input style="text-align:right;" class="form-control form-control-sm " name="saldo_act_q" id="saldo_act_q" type="text" value="<?php echo $saldoact ?>" disabled>
                </div>
                <div class="col-1"></div>
                <div class="col-1"></div>
                <a for="saldo_ven_s" class="col-sm-1 col-form-label">Saldo Vencido $</a>
                <div class="col-sm-1">
                  <input style="text-align:right;" class="form-control form-control-sm " name="saldo_ven_s" id="saldo_ven_s" type="text" value="<?php echo $saldoved ?>" disabled>
                </div>
                <a for="pago_min_s" class="col-sm-1 col-form-label">Pago Minimo $</a>
                <div class="col-sm-1">
                  <input style="text-align:right;" class="form-control form-control-sm " name="pago_min_s" id="pago_min_s" type="text" value="<?php echo $pagomind ?>" disabled>
                </div>
                <a for="saldo_ini_s" class="col-sm-1 col-form-label">Saldo Inicial $</a>
                <div class="col-sm-1">
                  <input style="text-align:right;" class="form-control form-control-sm " name="saldo_ini_s" id="saldo_ini_s" type="text" value="<?php echo $saldod ?>" disabled>
                </div>
                <a for="abono_s" class="col-sm-1 col-form-label">Abono $</a>
                <div class="col-sm-1">
                  <input style="text-align:right;" class="form-control form-control-sm " name="abono_s" id="abono_s" type="text" value="<?php echo $pagosd ?>" disabled>
                </div>
                <a for="saldo_act_s" class="col-sm-1 col-form-label">Saldo Actual $</a>
                <div class="col-sm-1">
                  <input style="text-align:right;" class="form-control form-control-sm " name="saldo_act_s" id="saldo_act_s" type="text" value="<?php echo $saldoacd ?>" disabled>
                </div>
                <div class="col-1"></div>
              </div>
            </div>
...
<div class="modal fade" id="m_telefonos" tabindex="-1" role="dialog" aria-labelledby="m_telefonos" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form id="formDataTelefono_m" method="POST">
          ...
          <div class="form-group col-12 row ">
            <div class="form-group col-12 row ">
              ...
              <div class="col-sm-4">
                <input class="form-control form-control-sm " onchange="fntNumExtract()" name="numero" id="numero" type="text">
              </div>
              <div class="col-4"></div>
              <a for="propietario" class="col-sm-4 col-form-label">Propietario</a>
              <div class="col-sm-8">
                <input class="form-control form-control-sm " name="propietario" id="propietario" type="text" required>
              </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button type="button" id="updateTell" onclick="fntInsertTelefono()" class="btn btn-primary">Guardar</button>
      </div>
    </div>
  </div>
</div>
...
<script>
  ...
  document.getElementById('updateTell').disabled = false;
