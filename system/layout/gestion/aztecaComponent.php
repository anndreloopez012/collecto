                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="one" role="tabpanel" aria-labelledby="one-tab"></br>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-4">
                                <div class="form-group row ">
                                    <a for="Credito" class="col-sm-4 col-form-label" disabled>CU</a>
                                    <div class="col-sm-4">
                                        <input class="form-control form-control-sm " name="Credito" id="Credito" type="text" value="<?php echo $codiclie ?>" disabled>
                                    </div>
                                    <div class="col-4"></div>
                                    <a for="Corte" class="col-sm-4 col-form-label">Pago Puntual</a>
                                    <div class="col-sm-4">
                                        <input style="text-align:right;" class="form-control form-control-sm " name="qotconve" id="qotconve" type="text" value="<?php echo $QOTCONVE ?>" disabled>
                                    </div>
                                    <div class="col-4"></div>
                                    <a for="Cartera" class="col-sm-4 col-form-label">Pago Requerido</a>
                                    <div class="col-sm-4">
                                        <input class="form-control form-control-sm " name="qotreneg" id="qotreneg" type="text" value="<?php echo $QOTRENEG ?>" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class=" col-4">
                                <div class="form-group row ">
                                    <a for="Credito" class="col-sm-3 col-form-label">Semama</a>
                                    <div class="col-sm-4">
                                        <input class="form-control form-control-sm " name="semana" id="semana" type="text" type="text" value="<?php echo $SEMANA ?>" disabled>
                                    </div>

                                    <div class="col-5"></div>
                                    <a for="Corte" class="col-sm-3 col-form-label">Dias en Atraso</a>
                                    <div class="col-sm-4">
                            ...
                            <div class=" col-3">
                                <div class="form-group row ">
                                    <a for="Mora" class="col-sm-4 col-form-label">Fecha ult. pago</a>
                                    <div class="col-sm-5">
                                        <input style="text-align:right;" class="form-control form-control-sm " name="fultpago" id="fultpago" type="text" value="<?php echo $fultpago ?>" disabled>
                                    </div>
                                    <a for="Llamadas" class="col-sm-4 col-form-label">Nivel de Riesgo</a>
                                    <div class="col-sm-5">
                                        <input style="text-align:right;" class="form-control form-control-sm " name="nivriesgo" id="nivriesgo" type="text" value="<?php echo $NIVRIESGO ?>" disabled>
                                    </div>
                                    <a for="Llamadas" class="col-sm-4 col-form-label">Saldo</a>
                                    <div class="col-sm-5">
                                        <input style="text-align:right;" class="form-control form-control-sm " name="saldo" id="saldo" type="text" value="<?php echo $saldo ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="nav nav-pills nav-fill btn-secondary AGREGAR">
                            <li class="nav-item" id="modalAzteca_" name="modalAzteca_">
                                <button type="button" onclick="fntUpModalAzteca()" id="modalAzteca_" name="modalAzteca_" class="btn btn-secondary btn-block">Azteca</button>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="TablaModalAzteca" id="TablaModalAzteca" name='TablaModalAzteca'>
                            <!---------------- TABLA DEL MODAL AZTECA-------------------------->
                        </div>
                        ...
                        <form id="formTipologiaGeneral" method="POST">
                            ...
                            <!--------------------------------- LLAMADA AZTECA----------------------------------------------------------------------------------------------------------------------------->
                            <input type="hidden" name="pais_az" id="pais_az" value="<?php echo $PAIS ?>">
                            <input type="hidden" name="canal_az" id="canal_az" value="<?php echo $CANAL ?>">
                            <input type="hidden" name="suc_az" id="suc_az" value="<?php echo $SUCURSAL ?>">
                            <input type="hidden" name="folio_az" id="folio_az" value="<?php echo $FOLIO ?>">
                            <input type="hidden" name="id_camp_az" id="id_camp_az" value="<?php echo $IDCAMPANA ?>">

                            <input type="hidden" name="gt" id="gt" value="<?php echo $gt ?>">
                            <div id="divnumView" name="divnumView">
                                <input type="hidden" name="numView" id="numView">
                            </div>
                            <input type="hidden" name="numOnmy" id="numOnmy" value="<?php echo $_GET["tn"] ?>">
                            <input type="hidden" name="nomAzteca" id="nomAzteca" value="<?php echo $_SESSION["USUARIO"] ?>">
                            <input type="hidden" name="idNomAzteca" id="idNomAzteca" value="<?php echo $_SESSION["A121"] ?>">
                            <input name="fechaAzteca" id="fechaAzteca" value="<?php echo date('m/d/Y') ?>" type="hidden">
...
<script>
    ...
    document.getElementById('modalAzteca_').style.display = 'none';
    ...
    ///////llamada azteca
    function fntSelectFrontAzteca(intParametro) {

        intParametro = !intParametro ? 0 : intParametro;
        if (intParametro > 0) {
            var strHidTell = $("#hid_tel_numero_" + intParametro).val();
            //alert(strHidTell + "                         strHidTell"+ intParametro);
            $("#numView").val(strHidTell);

        }
        fntDibujoFrontAzteca()
    }

    function fntRunAzteca() {
        var Tell = $("#numOnmy").val();
