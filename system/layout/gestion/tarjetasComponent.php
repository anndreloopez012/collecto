        ...
        <div class="tab-content">
          <div class="tab-pane active" id="one" role="tabpanel" aria-labelledby="one-tab"></br>
            ...
            <div class="form-group row ">
              ...
              <div class="col-4">
                <div class="form-group row ">
                  <a for="Targeta" class="col-sm-4 col-form-label" disabled>Tarjeta</a>
                  <div class="col-sm-4">
                    <input class="form-control form-control-sm " name="Targeta" id="Targeta" type="text" value="<?php echo $codiclie ?>" disabled>
                  </div>
                  <div class="col-4"></div>
                  <a for="Interno" class="col-sm-4 col-form-label">Interno</a>
                  <div class="col-sm-4">
                    <input class="form-control form-control-sm " name="Interno" id="Interno" type="text" type="text" value="<?php echo $codiempr ?>" disabled>
                  </div>
                  <div class="col-4"></div>
                  ...
                  <div class="col-4"></div>
                  <a for="Tipo" class="col-sm-4 col-form-label">Tipo de Producto</a>
                  <div class="col-sm-4">
                    <input style="text-align:right;" class="form-control form-control-sm " name="Tipo" id="Tipo" type="text" value="<?php echo $TIPOPROD ?>" disabled>
                  </div>
                </div>
              </div>
              <div class=" col-4">
                <div class="form-group row ">
                  <a for="Q" class="col-sm-3 col-form-label">F Ult Pago Q</a>
                  <div class="col-sm-4">
                    <input class="form-control form-control-sm " name="Q" id="Q" type="date" value="<?php echo $fultpago ?>" disabled>
                  </div>
                  <div class="col-5"></div>
                  <a for="Ult" class="col-sm-3 col-form-label">F Ult Pago $</a>
                  <div class="col-sm-4">
                    <input class="form-control form-control-sm " name="Ult" id="Ult" type="date" value="<?php echo $fultpagd ?>" disabled>
                  </div>
                  <div class="col-5"></div>
              ...
              <div class=" col-3">
                <div class="form-group row ">
                  ...
                  <a for="Conv" class="col-sm-4 col-form-label">Cuota Convenio</a>
                  <div class="col-sm-5">
                    <input style="text-align:right;" class="form-control form-control-sm " name="Conv" id="Conv" type="text" value="<?php echo $QOTCONVE ?>" disabled>
                  </div>
        ...
        <form id="formDataTelefono_m" method="POST">
          ...
          <div class="form-group col-12 row ">
            <div class="form-group col-12 row ">
              ...
              <select onchange="fntNumExtractProServ()" class="form-control-sm col-sm-4" name="owner" id="owner">
...
<div class="modal fade" id="update_telefono_modal">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
        ...
        <form id="formDataTelefono_update" method="POST">
          ...
          <div class="form-group col-12 row ">
            <div class="form-group col-12 row ">
              <a for="numero" class="col-sm-4 col-form-label">Numero</a>
              <div class="col-sm-4">
                <input class="form-control form-control-sm " onkeyup="fntNumExtract()" name="numero_tel" id="numero_tel" type="text" disabled>
              </div>
              <div class="col-4"></div>
              <a for="propietario" class="col-sm-4 col-form-label">Propietario</a>
              <div class="col-sm-8">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button type="button" onclick="fntUpdateActiveTelefonoBoton()" class="btn btn-primary">Guardar</button>
      </div>
    </div>
  </div>
</div>
...
<script>
  ...
  function fechaPromesa() {
    ...
    if (fechaIngreso < fechaActual) {
      alertify.alert('ATENCION!', 'No es posible agregar promesas de pago con fecha menor a la del dia actual!');
