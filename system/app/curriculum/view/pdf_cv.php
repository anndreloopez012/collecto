...
header("Content-Disposition: attachment; filename=COLLECTO.pdf");
header ("Cache-Control: no-cache, must-revalidate"); //no guardar en CACHE header("Pragma: no-cache");
header("Expires: 0");
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-2">
              <select id="sexo_per" name="sexo_per" class="form-control">
                ...
                <option value="masculino" <?php  if($sexo_per == 'masculino'){$selected='selected'; echo $selected;} ?> >Masculino</option>
                <option value="femenino" <?php  if($sexo_per == 'femenino'){$selected='selected'; echo $selected;} ?>>Femenino</option>
              </select>
            </div>
            <div class="form-group btn-info col-md-6">
            ...
            <div class="form-group col-md-6">
              &nbsp&nbsp&nbsp&nbsp<input class="form-check-input" type="radio" name="vive_con" id="vive_con" value="PADRES"  <?php  if($vive_con == 'PADRES'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="vive_con">
                PADRES
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="vive_con" id="vive_con" value="PARINTES"  <?php  if($vive_con == 'PARINTES'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="vive_con">
                PARIENTES
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="vive_con" id="vive_con" value="SOLO"  <?php  if($vive_con == 'SOLO'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="vive_con">
                SOLO
              </label>
            </div>
            ...
            <div class="form-group col-md-6">
              &nbsp&nbsp&nbsp&nbsp<input class="form-check-input" type="radio" name="depende_de" id="depende_de" value="HIJOS"  <?php  if($depende_de == 'HIJOS'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="depende_de">
                HIJOS
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="flexRadioDefault" id="depende_de" value="PADRES" <?php  if($depende_de == 'PADRES'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="depende_de">
                PADRES
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="depende_de" id="depende_de" value="CONYUGUE" <?php  if($depende_de == 'CONYUGUE'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="depende_de">
                CONYUGUE
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="depende_de" id="depende_de" value="NINGUNO" <?php  if($depende_de == 'NINGUNO'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="depende_de">
                NINGUNO
              </label>
            </div>
            <div class="form-group col-md-6">
              &nbsp&nbsp&nbsp&nbsp<input class="form-check-input" type="radio" name="estado_civil_per" id="estado_civil_per" value="SOLTERO" <?php  if($estado_civil_per == 'SOLTERO'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="estado_civil_per">
                SOLTERO
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="estado_civil_per" id="estado_civil_per" value="CASADO"  <?php  if($estado_civil_per == 'CASADO'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="estado_civil_per">
                CASADO
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="estado_civil_per" id="estado_civil_per" value="OTRO"  <?php  if($estado_civil_per == 'OTRO'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="estado_civil_per">
                OTRO
              </label>
            </div>
            ...
            <div class="form-group btn-info col-md-1">
              <label for="inputEmail4">VIVE</label>
            </div>
            <div class="form-group btn-info col-md-1">
              <label for="inputEmail4">FINADO</label>
            </div>
            <div class="form-group btn-info col-md-6">
              <label for="inputEmail4">DOMICILIO</label>
            </div>
            ...
            <div class="form-group col-md-1">
              <input type="text" class="form-control"  value="<?php echo $pat_vive ?>" id="pat_vive" name="pat_vive">
            </div>
            <div class="form-group col-md-1">
              <input type="text" class="form-control"  value="<?php echo $pat_finado ?>" id="pat_finado" name="pat_finado">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-1">
              <input type="text" class="form-control"  value="<?php echo $mat_finado ?>" id="mat_finado" name="mat_finado">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-1">
              <input type="text" class="form-control"  value="<?php echo $cony_finado ?>" id="cony_finado" name="cony_finado">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-4">
              &nbsp&nbsp&nbsp&nbsp<input class="form-check-input" type="radio" name="dat_gen_question_1" id="dat_gen_question_1" value="SI" <?php  if($dat_gen_question_1 == 'SI'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_1">
                SI
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="dat_gen_question_1" id="dat_gen_question_1" value="NO" <?php  if($dat_gen_question_1 == 'NO'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_">
                NO
              </label>
            </div>
            <div class="form-group col-md-4">
              &nbsp&nbsp&nbsp&nbsp<input class="form-check-input" type="radio" name="dat_gen_question_2" id="dat_gen_question_2" value="SI" <?php  if($dat_gen_question_2 == 'SI'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_2">
                SI
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="dat_gen_question_2" id="dat_gen_question_2" value="NO" <?php  if($dat_gen_question_2 == 'NO'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_2">
                NO
              </label>
            </div>
            <div class="form-group col-md-4">
              &nbsp&nbsp&nbsp&nbsp<input class="form-check-input" type="radio" name="dat_gen_question_3" id="dat_gen_question_3" value="SI" <?php  if($dat_gen_question_3 == 'SI'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_3">
                SI
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="dat_gen_question_3" id="dat_gen_question_3" value="NO" <?php  if($dat_gen_question_3 == 'NO'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_3">
                NO
              </label>
            </div>
            ...
            <div class="form-group col-md-4">
              &nbsp&nbsp&nbsp&nbsp<input class="form-check-input" type="radio" name="dat_gen_question_4" id="dat_gen_question_4" value="SI" <?php  if($dat_gen_question_4 == 'SI'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_4">
                SI
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="dat_gen_question_4" id="dat_gen_question_4" value="NO" <?php  if($dat_gen_question_4 == 'NO'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_">
                NO
              </label>
            </div>
            <div class="form-group col-md-4">
              &nbsp&nbsp&nbsp&nbsp<input class="form-check-input" type="radio" name="dat_gen_question_5" id="dat_gen_question_5" value="SI" <?php  if($dat_gen_question_5 == 'SI'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_5">
                SI
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="dat_gen_question_5" id="dat_gen_question_5" value="NO" <?php  if($dat_gen_question_5 == 'NO'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_5">
                NO
              </label>
            </div>
            <div class="form-group col-md-4">
              &nbsp&nbsp&nbsp&nbsp<input class="form-check-input" type="radio" name="dat_gen_question_6" id="dat_gen_question_6" value="SI" <?php  if($dat_gen_question_6 == 'SI'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_6">
                SI
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="dat_gen_question_6" id="dat_gen_question_6" value="NO" <?php  if($dat_gen_question_6 == 'NO'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_6">
                NO
              </label>
            </div>
            ...
            <div class="form-group col-md-4">
              &nbsp&nbsp&nbsp&nbsp<input class="form-check-input" type="radio" name="dat_gen_question_7" id="dat_gen_question_7" value="SI" <?php  if($dat_gen_question_7 == 'SI'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_7">
                SI
              </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <input class="form-check-input" type="radio" name="dat_gen_question_7" id="dat_gen_question_7" value="NO" <?php  if($dat_gen_question_7 == 'NO'){$checked='checked'; echo $checked;} ?>>
              <label class="form-check-label" for="dat_gen_question_7">
                NO
              </label>
            </div>
